...
class PGAgent(BaseAgent):
    ...
    def calculate_q_vals(self, rews_list):
        ...
        if not self.reward_to_go:
            # rews_list is a list of trajectories
        ...
        # concatenate all sub lists together
        return q_values
    ...
    def _discounted_return(self, rewards):
        ...
        # discounts and r_t' are the same dimensions now
        ...
        list_of_discounted_returns = [sum_of_discounted_rewards] * T
